...
// Unreal Engine Version is >= 4.18 OR in Unreal Engine 5
        ...
        FUniqueNetIdStringRef sref_fromId = FUniqueNetIdString::Create(fromId, TEXT("BCFOO"));
        FUniqueNetIdStringRef sref_messageId = FUniqueNetIdString::Create(messageId, TEXT("BCFOO"));
