...
const OperationParam OperationParam::LeaderboardServiceScoreData = OperationParam("scoreData");
const OperationParam OperationParam::LeaderboardServiceConfigJson = OperationParam("configJson");
