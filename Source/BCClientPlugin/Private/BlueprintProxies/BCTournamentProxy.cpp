...
UBCTournamentProxy *UBCTournamentProxy::PostTournamentScoreWithResults(UBrainCloudWrapper *brainCloudWrapper, const FString &leaderboardId, int32 score, const FString &jsonData, FDateTime roundStartedTime, ESortBoardOrder sort, int32 beforeCount, int32 afterCount, float initialScore)
{
	UBCTournamentProxy *Proxy = NewObject<UBCTournamentProxy>();
...
UBCTournamentProxy *UBCTournamentProxy::PostTournamentScoreWithResultsUTC(UBrainCloudWrapper *brainCloudWrapper, const FString &leaderboardId, int32 score, const FString &jsonData, int64 roundStartTimeUTC, ESortBoardOrder sort, int32 beforeCount, int32 afterCount, float initialScore)
{
	UBCTournamentProxy *Proxy = NewObject<UBCTournamentProxy>();
