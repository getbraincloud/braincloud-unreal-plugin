...
UBCLeaderboardProxy *UBCLeaderboardProxy::GetGlobalLeaderboardPage(UBrainCloudWrapper *brainCloudWrapper, FString leaderboardId, ESortBoardOrder sortOrder, int32 startIndex, int32 endIndex)
{
	UBCLeaderboardProxy *Proxy = NewObject<UBCLeaderboardProxy>();
...
UBCLeaderboardProxy *UBCLeaderboardProxy::GetGlobalLeaderboardPageByVersion(UBrainCloudWrapper *brainCloudWrapper, FString leaderboardId, ESortBoardOrder sortOrder, int32 startIndex, int32 endIndex, int32 versionId)
{
	UBCLeaderboardProxy *Proxy = NewObject<UBCLeaderboardProxy>();
...
UBCLeaderboardProxy *UBCLeaderboardProxy::GetGlobalLeaderboardView(UBrainCloudWrapper *brainCloudWrapper, FString leaderboardId, ESortBoardOrder sortOrder, int32 beforeCount, int32 afterCount)
{
	UBCLeaderboardProxy *Proxy = NewObject<UBCLeaderboardProxy>();
...
UBCLeaderboardProxy *UBCLeaderboardProxy::GetGlobalLeaderboardViewByVersion(UBrainCloudWrapper *brainCloudWrapper, FString leaderboardId, ESortBoardOrder sortOrder, int32 beforeCount, int32 afterCount, int32 versionId)
{
	UBCLeaderboardProxy *Proxy = NewObject<UBCLeaderboardProxy>();
...
UBCLeaderboardProxy *UBCLeaderboardProxy::GetGroupLeaderboardView(UBrainCloudWrapper *brainCloudWrapper, const FString &leaderboardId, const FString &groupId, ESortBoardOrder sortOrder, int32 beforeCount, int32 afterCount)
{
	UBCLeaderboardProxy *Proxy = NewObject<UBCLeaderboardProxy>();
...
UBCLeaderboardProxy *UBCLeaderboardProxy::GetGroupLeaderboardViewByVersion(UBrainCloudWrapper *brainCloudWrapper, const FString &leaderboardId, const FString &groupId, int32 versionId, ESortBoardOrder sortOrder, int32 beforeCount, int32 afterCount)
{
	UBCLeaderboardProxy *Proxy = NewObject<UBCLeaderboardProxy>();
