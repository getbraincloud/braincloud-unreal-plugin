...
void UBCClientProxy::EnableCompression(UBrainCloudWrapper* brainCloudWrapper, const bool isEnabled)
{
	UBCWrapperProxy::GetBrainCloudInstance(brainCloudWrapper)->getBCClient()->EnableCompression(isEnabled);
}
