...
public:
	...
	*/
	...
	/**
	* Get the country code from the SIM
	*/
	UFUNCTION(BlueprintCallable, Category = "Android Native Library|Basic")
	static FString GetCountryCodeSIM();

	/**
	* Get the country code from the Network
	*/
	UFUNCTION(BlueprintCallable, Category = "Android Native Library|Basic")
	static FString GetCountryCodeNetwork();

	/**
	* Get the country code from the Locale
	*/
	UFUNCTION(BlueprintCallable, Category = "Android Native Library|Basic")
	static FString GetCountryCodeLocale();
